					...
					try {
						...
						if (failLogIds!=null && !failLogIds.isEmpty()) {
							for (long failLogId: failLogIds) {
								...
								boolean alertMailEnable = XxlJobAdminConfig.getAdminConfig().isAlertMailEnable();
								if (info!=null && info.getAlarmEmail()!=null && info.getAlarmEmail().trim().length()>0 && alertMailEnable) {
